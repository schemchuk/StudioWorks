...
//            }
//        }
        Map<String, Integer> dictionaryStreams = Arrays.stream(words)
                .collect(Collectors.toMap(s -> s, s -> 1, Integer::sum));

        System.out.println(dictionaryStreams);
...
//entries.stream().map(entry -> new Word(entry.getKey(), (int) ((long) entry.getValue())))
//                .collect(Collectors.toCollection(TreeSet::new))
//                .forEach(word -> System.out.println("Word: '" + word.word + "'. Number of use: " + word.count));
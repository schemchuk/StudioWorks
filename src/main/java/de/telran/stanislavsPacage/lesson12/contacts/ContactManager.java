...
public class ContactManager {
    ...
    public void  addContact(Contact contact) {
        if (!contacts.contains(contact)){
            ...
            System.out.println("Contact " + contact.getName() + " is alreadys exist.");
        }
    }
    ...
    public void  deleteContact(Contact contact) {
        if (contacts.contains(contact)){
            ...
            System.out.println("Contact " + contact.getName() + " does'nt exist.");
        }
    }

    public void getAllContacts(){

        Comparator<Contact> comparatorContakts = new Comparator<Contact>() {
            @Override
            public int compare(Contact o1, Contact o2) {
                return o1.getName().compareTo(o2.getName());
            }
        };
        TreeSet<Contact> contactsSorted = new TreeSet<>(comparatorContakts);
